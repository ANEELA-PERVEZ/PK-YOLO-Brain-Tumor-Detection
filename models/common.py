...
class C3k2(nn.Module):
    # C3k2 Block for YOLO11 - Faster Feature Fusion
...
class PSA(nn.Module):
    # Position Sensitivity Attention (PSA) for YOLO11 Head
...
class RepViTBlock(nn.Module):
    # Basic RepViT Block for Backbone (Placeholder for mapped weights)
    def __init__(self, c1, c2, e=1.0):
        super().__init__()
        self.conv = Conv(c1, c2, 3, 1) # Standard conv replacement
        
    def forward(self, x):
        return self.conv(x)

class RepViTSEBlock(nn.Module):
    # Squeeze-and-Excitation Block for RepViT
    def __init__(self, c1, c2, e=1.0):
        super().__init__()
        self.conv = Conv(c1, c2, 1, 1) # 1x1 conv replacement
