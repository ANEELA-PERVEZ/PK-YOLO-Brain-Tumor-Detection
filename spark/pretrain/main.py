...
def main_pt():
  ...
  # build encoder and decoder
    enc = build_sparse_encoder(args.model, input_size=args.input_size, sbn=args.sbn, drop_path_rate=args.dp, verbose=False)

    # Sequence ko reverse karein: bare channels pehle, chote baad mein
    # [640, 320, 160, 80]
    enc.enc_feat_map_chs =[40, 80, 160, 320, 640]
    dec = LightDecoder(enc.downsample_raito, sbn=args.sbn, width=640)
    ...
    # Ye line ab error nahi degi kyunki indentation barabar hai
